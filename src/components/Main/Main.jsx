    ...
    <div className='main'>
        ...
        <div className="main-container">
            ...
            <div className="cards">
                ...
                <div className="card">
                    <p>Improve thereadability of the following code</p>
            ...
            <div className="main-bottom">
                <div className="search-box">
                    ...
                    <div>
                        <img src={assets.gal_icon} alt="" />
                        <img src={assets.mc_icon} alt="" />
                        {input?<img onClick={()=>onSent()} src={assets.snd_icon} alt="" />:null}
                    </div>
                </div>
